...
class Pattern(object):
    """Implement a pattern for led cube framework.
    self.cube.clear, self.cube.set_pixel are made avalible in time
    when Pattern instance is created in cube.py."""

    def init(self):
        self.double_buffer = True # Stop flickering bewteen ticks.
        self.life = Life(size=self.cube.size, 
                         limit=100, 
...
class Life(object):
    ...
    def __init__(self, size, limit, new_state_fn, next_generation_fn, limited=False):
        ...
        # self.color_change = self.__color_dim
        # self.color_change = self.__color_change_2black
        self.__restart()
